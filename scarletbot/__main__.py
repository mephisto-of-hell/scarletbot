...
import scarletbot.modules.sql.users_sql as sql
...
from scarletbot.modules import ALL_MODULES
from scarletbot.modules.helper_funcs.chat_status import is_user_admin
from scarletbot.modules.helper_funcs.misc import paginate_modules
...
✦  𝙃𝙚𝙮 𝘽𝙖𝙗𝙮,
𝙄 𝙖𝙢  𝙨𝙘𝙖𝙧𝙡𝙚𝙩 , 𝘼 𝙋𝙤𝙬𝙚𝙧𝙛𝙪𝙡𝙡 𝙖𝙡𝙡 𝙞𝙣 𝙤𝙣𝙚 𝙜𝙧𝙤𝙪𝙥 𝙢𝙖𝙣𝙖𝙜𝙚𝙢𝙚𝙣𝙩 𝙗𝙤𝙩 𝙥𝙡𝙪𝙨 𝙢𝙪𝙨𝙞𝙘 𝙗𝙤𝙩 𝙢𝙖𝙙𝙚 𝙛𝙤𝙧 𝙢𝙖𝙣𝙖𝙜𝙞𝙣𝙜 𝙮𝙤𝙪𝙧 𝙜𝙧𝙤𝙪𝙥𝙨 𝙚𝙛𝙛𝙚𝙘𝙩𝙞𝙫𝙚𝙡𝙮 𝙬𝙞𝙩𝙝 𝙨𝙤𝙢𝙚 𝙖𝙙𝙫𝙖𝙣𝙘𝙚 𝙨𝙚𝙘𝙪𝙧𝙞𝙩𝙮 𝙩𝙤𝙤𝙡𝙨 𝙖𝙣𝙙 𝘼𝙞 𝙛𝙪𝙣𝙘𝙩𝙞𝙤𝙣𝙨.

𝙄 𝙘𝙖𝙣 𝙝𝙚𝙡𝙥 𝙞𝙣 𝙢𝙖𝙣𝙖𝙜𝙞𝙣𝙜 𝙮𝙤𝙪𝙧 𝙜𝙧𝙤𝙪𝙥𝙨 𝙬𝙞𝙩𝙝 𝙪𝙨𝙚𝙛𝙪𝙡 𝙛𝙚𝙖𝙩𝙪𝙧𝙚𝙨, 𝙛𝙚𝙚𝙡 𝙛𝙧𝙚𝙚 𝙩𝙤 𝙖𝙙𝙙 𝙢𝙚 𝙩𝙤 𝙮𝙤𝙪𝙧 𝙜𝙧𝙤𝙪𝙥𝙨!

𝙷𝚒𝚝 𝚘𝚗 /𝚑𝚎𝚕𝚙 𝚊𝚗𝚍 𝚎𝚡𝚙𝚕𝚘𝚛𝚎 𝚖𝚘𝚛𝚎 . . .
"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("scarletbot.modules." + module_name)
...
@run_async
def scarlet_about_callback(update: Update, context: CallbackContext):
    query = update.callback_query
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != {OWNER_ID} and DONATION_LINK:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {dispatcher.bot.first_name} sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs [CRAZY BOY](https://t.me/Crazy_1299)"
...
╔═════ஜ۩۞۩ஜ═════╗
  ...
  ♨️𝗠𝗔𝗗𝗘 𝗕𝗬 [𝗖𝗥𝗔𝗭𝗬 𝗕𝗢𝗬](https://t.me/crazy_1299) 
...
""",
    ...
    about_callback_handler = CallbackQueryHandler(
        scarlet_about_callback, pattern=r"mukesh_"
    )
