...
import scarletbot.modules.sql.global_bans_sql as gban_sql
import scarletbot.modules.sql.users_sql as user_sql
from scarletbot import DEV_USERS, OWNER_ID, dispatcher
