...
class Config(object):
    ...
    OWNER_ID = "5231150389" # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = none
    SUPPORT_CHAT = none  # Your own group for support, do not add the @
    JOIN_LOGGER = (
        -1001723893843
